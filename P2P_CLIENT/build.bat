@echo off
REM build.bat - Script para construir executável do P2P Client no Windows
...
python -m PyInstaller --onefile --name p2p_client --log-level WARN main.py
...
echo Build concluido com sucesso! Executavel em \dist\p2p_client.exe
pause
